package my.edu.tarc.practical3;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            if(size<max){
                ...
                Toast.makeText(getApplicationContext(),"This is the maximum text size",Toast.LENGTH_SHORT).show();
            }
            ...
            if(size>min){
                ...
                Toast.makeText(getApplicationContext(),"This is the minimum text size",Toast.LENGTH_SHORT).show();
            }
